...
//! `cargo test -p ny-onnx --release --test slack_probe_cifar100 -- --ignored --nocapture`
...
#[test]
#[ignore = "multi-minute measurement on real cifar100 benchmark assets; run with --ignored"]
fn cifar100_f32_soundness_slack_measurement() {
