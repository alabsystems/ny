-- NY-owned proof overlays over the pinned Clean Crownproof library.
--
-- Clean is a Lake dependency.  Keep only NY-specific proofs here; shared
-- Crownproof modules belong in Clean and must not be copied into this tree.
